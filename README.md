[![Deploy to GitHub Pages](https://github.com/Onemored/hw-filter/actions/workflows/deploy.yml/badge.svg)](https://github.com/Onemored/hw-filter/actions/workflows/deploy.yml)

Портфолио с фильтрами
===

Демо: https://onemored.github.io/hw-filter/
